  ...
  return (
    <div className={`${className} relative overflow-hidden`}>
      ...
      <img
        ...
        style={{ opacity: isLoaded ? 1 : 0, imageRendering: "auto" }}
...
export default function PolaroidWall() {
  ...
  return (
    <section ref={sectionRef} className="relative py-16 md:py-24">
      ...
      >
        <h2 className="text-2xl md:text-3xl text-gold tracking-wider" style={{ fontFamily: "var(--font-dancing)" }}>
          Our Memories
        </h2>
      </motion.div>
              ...
              {[...row, ...row].map((photo, idx) => {
                ...
                return (
                  <div
                    key={`${rowIndex}-${idx}`}
                    className="polaroid"
                    style={{ ["--rotate" as string]: `${ROTATIONS[originalIndex % ROTATIONS.length]}deg` }}
                    onClick={(e) => {
                      e.stopPropagation();
